    ...
    return [
      ...
      },
      {
        ...
        episodes: [
          ...
          // { number: 12,      name: "Deposition",              videoUrl: '' },
          // { number: 13,      name: "Dinner Party",            videoUrl: '' },
          // { number: 14,      name: "Dinner Party",            videoUrl: '' },
          // { number: 15,      name: "Night Out",               videoUrl: '' },
          // { number: 16,      name: "Did I Stutter?",          videoUrl: '' },
          // { number: 17,      name: "Job Fair",                videoUrl: '' },
          // { number: '18-19', name: "Goodbye Toby",            videoUrl: '' },
        ]
      },
      // {
      //   number: 3,
